...
export const FIRST_QUESTION = {
    RU: `Давай начнём с знакомства. Расскажи, пожалуйста, о себе — как тебя зовут, когда ты родился, сколько тебе лет, есть ли у тебя семья или дети, чем ты увлекаешься.
Эти данные помогут лучше понять твой жизненный контекст и сформировать максимально точный персональный портрет. Вся информация хранится только у тебя на устройстве, под шифрованием, и не передаётся наружу.`,
    EN: `Let’s start by getting to know you. Please tell me about yourself — your name, date of birth, age, whether you have a family or children, and what your interests are.
