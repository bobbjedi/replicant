...
- Города и места, в которых бывал человек:
  - Формат записи: **[город/место] — [цель пребывания или события]**
  - Например: *Москва — учеба в университете*, *Париж — туристическая поездка в 2018*, *Новосибирск — переезд с семьей в детстве*
- Переезды:
  - Формат записи: **[откуда] → [куда], [возраст или дата] (если указано), причина (если указана)**
...
- Города и места, в которых бывал:
  - [город/место] — [цель пребывания или событие]
- Переезды:
  - [откуда] → [куда], [возраст или дата] (если указано), причина (если сказана)
\`\`\`
`,
